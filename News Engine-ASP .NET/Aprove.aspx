<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Aprove.aspx.cs" Inherits="Aprove" %>
                ...
                <ItemTemplate >
                    ...
                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString='<%$ ConnectionStrings:DefaultConnection %>' SelectCommand="SELECT [Id], [titlu] FROM [Stiri] WHERE (([id_categorie] = @id_categorie) AND ([aprobat] = @aprobat)) ORDER BY [data_adaugare] DESC">
                        <SelectParameters>
                            ...
                            <asp:Parameter DefaultValue="False" Name="aprobat" Type="Boolean"></asp:Parameter>
                        </SelectParameters>
                    </asp:SqlDataSource>
                        ...
                        <ItemTemplate>
                            <div class="row" style="width:30%;height:35%;display:inline-block;margin:1% 1%;align-content:center;" >
                                ...
                                <h3 id="titlu" class="h3" style="text-align:center;">
                                    <asp:HyperLink  runat="server" NavigateUrl='<%#"~/NewsAprove.aspx?id=" + Eval("id")%>'> <%# Eval("titlu") %></asp:HyperLink>  
                                </h3>
                            </div>
                        </ItemTemplate>
                    </asp:Repeater>
