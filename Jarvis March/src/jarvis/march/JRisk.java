...
public class JRisk {
    ...
    public JRisk(final double x[], final double y[], final int xPoly[], final int yPoly[],Punct puncte[],final int lung) {
        initComponents(x, y, xPoly, yPoly,puncte,lung);
    }

    private void initComponents(final double x[], final double y[], final int xPoly[], final int yPoly[],Punct puncte[],final int lung) {
        ...
        JPanel p = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                /*for (int i = 0; i < xPoly.length; ++i) {
                    g2d.fillOval(xPoly[i] - 5, yPoly[i] - 5, 10, 10);
                    String c;
                    c = (String) ("P" + indici[i] + '(' + x[i] + ',' + y[i] + ')');
                    g.drawString(c, xPoly[i] - 5, yPoly[i] - 5);
                }*/
