...
public class JarvisMarch {
    ...
    public static void main(String[] args) {
        ...
        int[] xPoly = new int[x.nrAcoperire];
        int[] yPoly = new int[x.nrAcoperire];
        double[] xx = new double[x.nrAcoperire];
        double[] yy = new double[x.nrAcoperire];
